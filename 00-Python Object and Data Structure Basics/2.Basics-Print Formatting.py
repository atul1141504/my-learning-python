...
#        4. String Formatting - The newest method, introduced with Python 3.6, 
...
#            # For one, you can bring outside variables immediately into to the string 
#              rather than pass them as arguments through .format(var).
...
#     Method_2 = using %r or repr() -> deliver the string representation of the object, 
...
#			  We can pass an optional <,^, or > to set a left, center or right alignment:
print("\n")
print('{0:<8} | {1:^8} | {2:>8}'.format('Left','Center','Right'))
print('{0:<8} | {1:^8} | {2:>8}'.format(11,22,33.1))

#             We can precede the aligment operator with a padding character
