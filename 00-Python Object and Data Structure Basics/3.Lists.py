'''>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    1. Lists
        ...
        c.) Basic List Methods
            ...
            -> Pop - Use pop to "pop off" an item from the list. By default pop takes off the last index, but you can also specify which index to pop off, remember default popped index is -1
